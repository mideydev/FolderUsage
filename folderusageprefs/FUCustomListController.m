...
@implementation FUCustomListController
...
- (void)loadSettings
{
	...
	_tweakSettings = ([NSMutableDictionary dictionaryWithContentsOfFile:@FU_PREFS_FILE] ?: [NSMutableDictionary dictionary]);
...
- (void)saveSettings
{
	...
	[_tweakSettings writeToFile:@FU_PREFS_FILE atomically:YES];
